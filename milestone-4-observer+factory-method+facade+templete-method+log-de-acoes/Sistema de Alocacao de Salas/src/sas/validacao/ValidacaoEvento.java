...
public class ValidacaoEvento {
	...
	public void adicionarEventoCompleto(String id, String nome, String inicio,
		...
		} else if (nome.equalsIgnoreCase("") || area.equalsIgnoreCase("")
	...
	/**
	 * 
	 * Metodo responsavel por adicionar um evento com tipo de repeticao
	 * 
	 * @param id
	 *            ID que o Evento tera
	 * @param nome
	 ...
	 *            para um evento de uma repeticao)
	 * @param tipoRepeticao
	 * 			  Tipo de repeticao do evento (semanal, mensal, diario...)
	 * @throws RoomsAllocationException
	 *             Excecao que pode ser lancada, caso as informacoes inseridas
	 *             nao estejam corretas
	 */

	public void adicionarEventoCompletoTipado(String id, String nome,
			String inicio, String fim, String area, String contato,
			int repeticoes, String tipoRepeticao)
			throws RoomsAllocationException {
		ops = new OperacoesEvento();
		if (id == null || id.equalsIgnoreCase("")) {
			throw new IdentificacaoInvalidaException("Identificacao Invalida");
	...
	public void getAtributoEvento(String idEvento, String atributo)
		...
		if (idEvento == null) {
			throw new EventoInexistenteException("Evento nao existe.");
				...
				&& !atributo.equalsIgnoreCase("inicio")
				&& !atributo.equalsIgnoreCase("fim")
				&& !atributo.equalsIgnoreCase("contato")
				&& !atributo.equalsIgnoreCase("area")
				&& !atributo.equalsIgnoreCase("repeticoes")
