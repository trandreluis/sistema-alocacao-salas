...
public class OperacoesEvento implements Sujeito {
	...
	public void adicionarEventoCompletoTipado(String id, String nome, String inicio,
			String fim, String area, String contato, int repeticoes, String tipoRepeticao)
			throws RoomsAllocationException {

		validacao.adicionarEventoCompletoTipado(id, nome, inicio, fim, area, contato,
		...
		novoEvento.setContato(contato);
		novoEvento.setRepeticoes(repeticoes);
		novoEvento.setTipoRepeticao(tipoRepeticao);
