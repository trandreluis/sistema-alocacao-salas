...
public class AdicionarAlocacao extends JFrame {
	...
	public AdicionarAlocacao(Principal janelaPrincipal) {
		...
		botaoCadastrarAlocacao.setBounds(208, 415, 50, 50);
		...
		botaoCancelar.setBounds(408, 415, 50, 50);
		...
		lblTipo_1.setBounds(388, 357, 63, 22);
		panePrincipal.add(lblTipo_1);
		
		fieldTipo = new JTextField();
		fieldTipo.setBounds(465, 351, 117, 28);
		fieldTipo.setFocusable(false);
		fieldTipo.setEditable(false);
		panePrincipal.add(fieldTipo);
