...
public class SalaDao extends GenericDao {
	 ...
	 * @param sala Objeto a ser salvo no Banco
	 */
	 ...
	 * @param idSala ID de uma Sala a ser buscada
	 ...
	 * @param idSala ID da sala que tera o atributo retornado
	 * @param atributo Atributo que a sala contem (ex.: capacidade, apelido e etc...)
	 ...
	 * @param idSala ID da sala a ser verificada a existencia
