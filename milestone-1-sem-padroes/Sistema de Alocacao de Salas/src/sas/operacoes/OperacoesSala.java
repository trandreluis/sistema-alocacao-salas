...
public class OperacoesSala {

	Sala novaSala = null;
	SalaDao crudSala = null;
	ArrayList<Sala> salas = null;
	OperacoesAlocacao opa = null;
	...
	public void removerSala(String idSala) throws RoomsAllocationException {
		...
		opa = new OperacoesAlocacao();

		if (opa.verificarExistenciaSala(idSala)) {
			opa.desalocarEvento(opa.getIdEvento(idSala));
		}
