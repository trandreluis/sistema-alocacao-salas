...
public class ValidacaoAlocacao {
	 ...
	 * 
	 * @param idEvento
	 *            ID do Evento que sera alocado
	 * @param idSala
	 *            ID da Sala que recebera o Evento
	 * @throws RoomsAllocationException
	 *             Excecao que pode ser lancada caso as informacoes sejam
	 *             invalidas para alocacao
	 */
	...
	public void alocarEvento(String idEvento, String idSala)
		...
		if (opEvento.verificarExistencia(idEvento) == false
				...
				|| idEvento.equalsIgnoreCase("") || idSala.equalsIgnoreCase("")) {
		...
		opAlocacao = new OperacoesAlocacao(opSala, opEvento);
	...
	/**
	 * Metodo responsavel por validar as entradas de o metodo localizaEvento()
	 * rebcebe
	 * 
	 * @param nome
	 *            Nome fornecido no metodo
	 * @param valor
	 *            Valor que o "nome" devera possuir
	 * @throws RoomsAllocationException
	 *             Excecao que pode ser lancada caso as infromacoes passadas
	 *             sejam incorretas
	 */
	 ...
	 * 
	 * @param idEvento
	 *            ID do evento a ser desalocado
	 * @throws RoomsAllocationException
	 *             Excecao que pode ser lancada caso as informacoes passadas nao
	 *             sejam validas
	 */
