...
public class FachadaAlocacao implements IFacadeRoomsAllocation {
	...
	private OperacoesSala operacoesSala = new OperacoesSala();
	private OperacoesEvento operacoesEvento = new OperacoesEvento();
	private OperacoesAlocacao staticOpAlocacao = new OperacoesAlocacao(operacoesSala, operacoesEvento);
	
	public static void main(String[] args) {
		
		BancoDerby banco = new BancoDerby();
		try {
			System.out.println("Conectando/criando banco... \n(por favor, espere, este processo pode demorar um pouco)");
			banco.criarBanco();
			System.out.println();
	...
	public void adicionarSala(String id, int capacidade, String finalidade,
		...
		// Feito, testado: sucesso
		operacoesSala.adicionarSalaBasico(id, capacidade, finalidade, tipo);
	...
	public void adicionarSala(String id, int capacidade, String finalidade,
		...
		// Feito, testado: sucesso
		operacoesSala.adicionarSalaMedio(id, capacidade, finalidade, tipo, apelido);
	}
	...
	public void adicionarSala(String id, int capacidade, String finalidade,
		...
		// Feito, testado: sucesso
		operacoesSala.adicionarSalaCompleto(id, capacidade, finalidade, tipo, apelido, aberto);
	}
	...
	public String getAtributoSala(String idSala, String atributo)
		...
		return operacoesSala.getAtributo(idSala, atributo);
	}
	...
	public void adicionarEvento(String id, String nome, String inicio,
			...
			throws RoomsAllocationException {
		// Feito, testado: sucesso
		operacoesEvento.adicionarEventoCompleto(id, nome, inicio, fim, area, contato, repeticoes);
	...
	public void adicionarEvento(String id, String nome, String inicio,
			...
			throws RoomsAllocationException {
		// Feito, testado: sucesso
		operacoesEvento.adicionarEventoBasico(id, nome, inicio, fim, area, contato);
	...
	public Object getAtributoEvento(String idEvento, String atributo)
			throws RoomsAllocationException {
		// Feito, testado: sucesso
		return operacoesEvento.getAtributo(idEvento, atributo);
	}
